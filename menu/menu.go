...
func main() {
	...
	AddToTail(pLinkTable, InitLinkNode("3lo"))
	AddToTail(pLinkTable, InitLinkNode("2022"))
	AddToHead(pLinkTable, InitLinkNode("xyz"))
	ShowLinkTableValues(pLinkTable)
	...
	fmt.Println("查找值为xyz的结点:", SelectLinkNode(pLinkTable, "xyz"))
	fmt.Println("查找值为2022的结点:", SelectLinkNode(pLinkTable, "2022"))
	DeleteFirstValueNode(pLinkTable, "xyz")
	DeleteFirstValueNode(pLinkTable, "2022")
	ShowLinkTableValues(pLinkTable)
}
